...
## Summary
Adaptable DevSecOps and Platform Engineer with a proven track record of bridging the gap between robust security and high-velocity developer productivity. Holder of four Google Cloud Professional certifications (Architect, Security Engineer, Network Engineer, Generative AI Leader) — a combination that enables end-to-end ownership of secure, cloud-native AI platforms. Experienced in designing cost-effective, scalable AI platforms on GCP, automating complex infrastructure workflows, and embedding AI/LLM integrations into developer environments. Currently deepening expertise in ML Engineering. A passionate community leader, youth advocate, and technical mentor.
...
- [Security Checks with Local LLMs](https://dev.to/alexandertyutin/security-checks-with-local-llms-3d4m)
*(More available on Dev.to)*
...
- Designed and built the first unified Software Composition Analysis (SCA) process from scratch using Python and Ansible automation.
- Spearheaded DevSecOps advocacy, successfully driving the adoption of the SCA process across almost all engineering teams within a year through continuous maintenance and training.
...
- Engineered security designs for containerized environments (Docker, Kubernetes), including network policy design for inter-service isolation.
...
- Integrated security seamlessly across the entire development lifecycle: code commit, Docker image building, artifact storage, and runtime environments.
- Partnered closely with the DevOps team to maintain infrastructure security without hindering deployment velocity.
...
- Created and managed a new Anti-Fraud Division from scratch, leading team education, process design, and incident handling.
...
**AppSecFest Kazakhstan 2026** | *Speaker*
- Presented: "From VibeCoding to Enterprise-level Specification-Driven Development: Accounting, Control, and Management."
- Shared expertise on scaling AI-assisted development processes and governing AI products using ISO IEC 42001:2023 and Responsible AI principles.

**Toastmasters: Nomads of Digital Era 2026** | *Speaker*
- Spoke on cloud security, AI governance, and empowering young STEM innovators.

**Google Developer Groups (GDG) Almaty** | *Organizer & Speaker*
- Co-hosted and spoke at the "Build with AI Central Asia" workshop, driving local developer adoption of Google AI technologies.

## Education
**North-Caucasus State Technical University**
Master's degree, Computer and Information Systems Security/Information Assurance (2005 - 2010)

## Languages
Russian (Native), English (Professional Working)

## Certifications (Google Cloud)
- Professional Cloud Architect (PCA) — [Credly](https://www.credly.com/badges/ec987b5a-76db-4232-91f3-89faf889d2d9)
- Professional Cloud Security Engineer (PCSE) — [Credly](https://www.credly.com/badges/d0716545-1698-4c03-b5f1-514a230ac741)
- Professional Cloud Network Engineer (PCNE) — [Credly](https://www.credly.com/badges/f8c82fe2-1264-4107-ac75-c7d0eaab374a)
- Generative AI Leader (GAIL) — [Credly](https://www.credly.com/badges/84a19293-3d6d-47db-8067-c2dadc130f60)
